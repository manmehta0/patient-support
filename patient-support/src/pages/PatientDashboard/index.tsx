...
export const PatientDashboard: React.FC<PatientDashboardProps> = ({ patientId }) => {
  ...
  return (
    <div className='container mx-auto px-4 py-8'>
      ...
      {/* Chatbot Flyout */}
      <div className={`fixed bottom-3 right-0 h-[95%] transition-transform duration-300 ease-in-out transform ${isChatbotOpen ? 'translate-x-0' : 'translate-x-full'} bg-gray-800 border border-gray-700 rounded-lg shadow-lg`}>
